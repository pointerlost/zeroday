...
const int BINDING_PHASE_BATCH      = 4;
const int BINDING_ENTITY_METADATA  = 5;
const int BINDING_VISIBLE_ENTITIES = 6;
const int BINDING_COMMANDS         = 7;
const int BINDING_PAYLOADS         = 8;
